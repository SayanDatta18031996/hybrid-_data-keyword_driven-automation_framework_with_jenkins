...
public class AddCustomerTest extends TestBase {
	...
	public void addCustomer(Hashtable<String,String> Data) throws InterruptedException {
		...
		typing("addCustomerPostCode_css",Data.get("postCode"));
